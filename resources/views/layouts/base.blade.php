                    ...
                    <div class="col-lg-12">
                        <div class="main-menu">
                                ...
                                <div class="main-navbar">
                                    <div id="mainnav">
                                        ...
                                        <ul class="nav-menu">
                                            ...
                                            <li><a href="{{ route('about.index') }}" class="nav-link menu-title">About
                                                    Us</a></li>
                                            <li><a href="{{ route('contact.index') }}"
                                                    class="nav-link menu-title">Contact Us</a></li>
                                        </ul>
                                    </div>
                                </div>
                            </nav>
                            ...
                            <div class="search-full">
                                <form method="GET" class="search-full" action="{{ route('search') }}">
                                    <div class="input-group">
                                        <span class="input-group-text">
                                            <i data-feather="search" class="font-light"></i>
                                        </span>
                                        <input type="text" name="q" class="form-control search-type" placeholder="Search here..">
                                        <span class="input-group-text close-search" style="cursor: pointer;">
                            ...
                            <script>
                                ...
                                document.querySelector('.close-search').addEventListener('click', function() {
                                    document.querySelector('.search-full').style.display = 'none';
                                });
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6">
                        <div class="footer-contact">
                            ...
                            <ul class="contact-lists" style="clear:both;">
                                <li>
                                    <span><b>phone:</b> <span class="font-light"> +84 0000000000</span></span>
                                </li>
                                <li>
                                    <span><b>Address:</b><span class="font-light"> Tan Phu
                                            VietNam</span></span>
                                </li>
                                <li>
                                    <span><b>Email:</b><span class="font-light"> TSL@gmail.com</span></span>
                                </li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="col-xl-2 col-lg-3 col-md-4 col-sm-6">
                        <div class="footer-links">
                            ...
                            <div class="footer-content">
                                <ul>
                                    <li>
                                        <a href="shop.html" class="font-dark">Latest</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
