                                ...
                                <div class="row">
                                    <div class="col-lg-2">
                                        <div class="details-image-vertical black-slide rounded">
                                            ...
                                            @if ($product->images)  <!-- Kiểm tra xem có hình ảnh không -->
                                                @php
                                                    $images = json_decode($product->images, true);
                                                @endphp
                                                @foreach ($images as $image)
                                                    <div>
                                                        <img src="{{ asset('/assets/images/fashion/product/') }}/{{($image) }}"
                                    ...
                                    <div class="col-lg-10">
                                        <div class="details-image-1 ratio_asos">
                                            <div>
                                                <img src="{{ asset('/assets/images/fashion/product/') }}/{{ $product->image }}"
                            ...
                            <div class="col-md-6">
                                <div class="cloth-details-size">
                                    ...
                                    <div class="label-section">
                                        <span class="badge badge-grey-color">#</span>
                                        ...
                                        <div class="qty-box">
                                            <div class="input-group">
                                                <span class="input-group-prepend">
                                                    <button type="button" class="btn quantity-left-minus" onclick="updateQuantity('minus')" data-type="minus" data-field="">
                                                        <i class="fas fa-minus"></i>
                                                    </button>
                                                </span>
                                                <input type="number" name="quantity" id="quantity" class="form-control input-number" value="1" min="1">
                                                <span class="input-group-prepend">
                                                    <button type="button" class="btn quantity-right-plus" onclick="updateQuantity('plus')" data-type="plus" data-field="">
                                    ...
                                    <div class="product-buttons">
                                        ...
                                        <a href="javascript:void(0)" onclick="event.preventDefault(); addToCart()"
                                    ...
                                    <script>
                                        function updateQuantity(type) {
                                            ...
                                            if (type === 'plus') {
                                                ...
                                                quantityInput.value = currentValue - 1; // Giảm số lượng, nhưng không cho phép xuống dưới 1
                                            }
                                        }
                                    
                                        function addToCart() {
                                            var quantityInput = document.getElementById('quantity');
                                            document.getElementById('qty').value = quantityInput.value; // Cập nhật số lượng vào form
                                            document.getElementById('addtocart').submit(); // Gửi form
                                        }
                                    </script>
                    ...
                    <div class="cloth-review">
                        ...
                        <div class="tab-content" id="nav-tabContent">
                            ...
                            <div class="tab-pane fade" id="speci">
                                <div class="pro mb-4">
                                    <p class="font-light">Suntory PepsiCo mang đến niềm vui cho hàng triệu người 
                                        Việt Nam qua danh mục sản phẩm đa dạng và đổi mới. Chúng tôi đã và đang nghiên cứu 
                                        để cho ra đời những sản phẩm giảm đường hoặc không đường, bổ sung vitamin và khoáng chất, 
                                        đáp ứng nhu cầu về một lối sống lành mạnh của người dùng. </p>
                                ...
                                <div class="img-wrapper">
                                    <div class="front">
                                        <a href="{{route('shop.product.details',['slug'=>$rproduct->slug])}}">
                                            <img src="{{asset('assets/images/fashion/product')}}/{{$rproduct->image}}"
