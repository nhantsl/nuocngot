                        ...
                        <tr>
                            <td>
                                <a href="{{route('shop.product.details',['slug'=>$item->model->slug])}}">
                                    <img src="{{asset('assets/images/fashion/product/')}}/{{$item->model->image}}" class="blur-up lazyloaded"
                                        alt="{{$item->model->name}}">
                                </a>
                            </td>
                            <td>
                    ...
                    <div class="col-lg-4 col-sm-6 ">
                        <div class="checkout-button">
                            <form method="get" action="{{ route('checkout.index') }}">
                                @csrf
                                <button type="submit" class="btn btn-solid-default btn fw-bold">
